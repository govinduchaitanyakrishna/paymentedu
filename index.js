         ...
         post_res.on('end', function(){
           ...
           var _results = JSON.parse(response);
             if(_results.STATUS == 'TXN_SUCCESS') {
                ...
                res.redirect(`https://zomo-live-2021.herokuapp.com/viewOrder?status=${_results.STATUS}&ORDERID=${_results.ORDERID}&date=${_results.TXNDATE}&bank=${_results.BANKNAME}`)
             }else {
